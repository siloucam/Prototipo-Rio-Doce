...
import br.inf.ufes.config.audit.AuditEventConverter;
import br.inf.ufes.domain.PersistentAuditEvent;
...
import static br.inf.ufes.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
